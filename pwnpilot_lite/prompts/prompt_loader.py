...
class PromptLoader:
    ...
    FALLBACK_BASIC = (
        ...
        "IMPORTANT: When using nmap or other network scanning tools, ALWAYS remove protocol "
        "prefixes (http://, https://, ftp://, etc.) from target hostnames. Nmap expects "
        "hostnames or IP addresses, NOT URLs. For example:\n"
